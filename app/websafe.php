...
function webscan_pape(){
  ...
  <center><iframe width="100%" align="center" height="870" frameborder="0" scrolling="no" src="/static/safe/nosafe.html"></iframe></center>
  </body>
  </html>
HTML;
  echo $pape;
...
function webscan_white($webscan_white_name,$webscan_white_url=array()) {
  ...
  if (preg_match("/".$webscan_white_name."/is",$url_uri)==1&&!empty($webscan_white_name)) {
    return false;
  }
